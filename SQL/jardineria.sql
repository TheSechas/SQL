...
CREATE TABLE IF NOT EXISTS `jardineria`.`empleado` (
  ...
  CONSTRAINT `empleadoTOoficinaFK`
    FOREIGN KEY (`codigo_oficina`)
    REFERENCES `jardineria`.`oficina` (`codigo_oficina`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `empleadoTOempleado`
    FOREIGN KEY (`codigo_jefe`)
    REFERENCES `jardineria`.`empleado` (`codigo_empleado`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;

CREATE INDEX `empleadoTOoficinaFK_idx` ON `jardineria`.`empleado` (`codigo_oficina` ASC) VISIBLE;

CREATE INDEX `empleadoTOempleado_idx` ON `jardineria`.`empleado` (`codigo_jefe` ASC) VISIBLE;
...
CREATE INDEX `clienteTOempleado_idx` ON `jardineria`.`cliente` (`codigo_empleado_rep_ventas` ASC) VISIBLE;
...
CREATE TABLE IF NOT EXISTS `jardineria`.`pedido` (
  ...
  CONSTRAINT `pedidoTOclienteFK`
    FOREIGN KEY (`codigo_cliente`)
    REFERENCES `jardineria`.`cliente` (`codigo_cliente`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;

CREATE INDEX `pedidoTOclienteFK_idx` ON `jardineria`.`pedido` (`codigo_cliente` ASC) VISIBLE;


-- -----------------------------------------------------
-- Table `mydb`.`gama_producto`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `jardineria`.`gama_producto` (
...
CREATE TABLE IF NOT EXISTS `jardineria`.`producto` (
  ...
  CONSTRAINT `productoTOgama_producto`
    FOREIGN KEY (`gama`)
    REFERENCES `jardineria`.`gama_producto` (`gama`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;

CREATE INDEX `productoTOgama_producto_idx` ON `jardineria`.`producto` (`gama` ASC) VISIBLE;


-- -----------------------------------------------------
-- Table `mydb`.`pago`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `jardineria`.`pago` (
  `codigo_cliente` INT NOT NULL,
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `jardineria`.`detalle_pedido` (
  `codigo_pedido` INT NOT NULL AUTO_INCREMENT,
  `codigo_producto` VARCHAR(15) NOT NULL,
  ...
  CONSTRAINT `detalle_pedidoTOpedidoFK`
    FOREIGN KEY (`codigo_pedido`)
    REFERENCES `jardineria`.`pedido` (`codigo_pedido`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `detalle_pedidoTOproductoFK`
    FOREIGN KEY (`codigo_producto`)
    REFERENCES `jardineria`.`producto` (`codigo_producto`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;

CREATE INDEX `detalle_pedidoTOproductoFK_idx` ON `jardineria`.`detalle_pedido` (`codigo_producto` ASC) VISIBLE;
